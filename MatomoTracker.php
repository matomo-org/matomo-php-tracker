 ...
 * @link http://matomo.org/docs/tracking-api/
 *
 * @category Matomo
...
class MatomoTracker
{
     ...
     * @return $this
     * @throws Exception
     * @see function getAttributionInfo() in https://github.com/matomo/matomo/blob/master/js/matomo.js
     */
     ...
     * See http://matomo.org/docs/custom-variables/
     *
    ...
    /**
     * Force the separator for decimal point to be a dot. See https://github.com/matomo/matomo/issues/6435
...
/**
 * Ensure compatibility with old tracking call
 */
class_alias('MatomoTracker', 'PiwikTracker');
